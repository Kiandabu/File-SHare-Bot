...
### Installation
#### Deploy on Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Kiandabu/File-SHare-Bot)</br>
...
#### Deploy in your VPS
````bash
git clone https:https://github.com/Kiandabu/File-SHare-Bot
